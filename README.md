...
一个面向中文学术论文、学位论文、开题报告和研究报告的**保真表达编辑器**。它处理已经完成或已有初稿的文本，定位模板化、机械化、重复或不自然的表达，并在保护事实、数据、引用、研究阶段和结论边界的前提下进行最小修改。这里的“去 AI 化表述”指可观察的写作问题，**不是 AI 作者检测**；本项目不从零生成论文，不提供 AI 生成概率，也不保证通过检测。
